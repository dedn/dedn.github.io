...
(function($) {
	...
	FlipClock.DailyCounterFace = FlipClock.Face.extend({
		...
		build: function(time) {
			...
			$(this.createDivider('λ')).insertBefore(this.lists[this.lists.length - 4 + offset].$el);
			$(this.createDivider('ω')).insertBefore(this.lists[this.lists.length - 6 + offset].$el);
			$(this.createDivider('μ', true)).insertBefore(this.lists[0].$el);
